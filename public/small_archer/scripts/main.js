...
'use strict';
{
    ...
    window.RuntimeInterface = class RuntimeInterface {
        ...
        _GetWorkerURL(url) {
            ...
            else if (this._exportType === "playable-ad" && this._localFileBlobs.hasOwnProperty(url))
        ...
        _OnScreenReaderTextEvent(e) {
            ...
            if (type === "create") {
                ...
                if (p)
                    ...
                    console.warn(`[Construct] Missing screen reader text with id ${e["id"]}`)
        ...
        *audioInstancesByEffectTag(tag) {
        ...
        async _OnLoadState(e) {
            ...
            if (saveLoadMode !== 3) {
                ...
                for (const ai of this._audioInstances)
                    if (ai.IsMusic() && saveLoadMode === 1 || !ai.IsMusic() && saveLoadMode === 2)
...
;'use strict';
{
    ...
    self.C3AudioInstance = class C3AudioInstance {
        ...
        SetStereoPannerEnabled(e) {
            e = !!e;
            if (this._isStereoPannerEnabled === e)
                return;
